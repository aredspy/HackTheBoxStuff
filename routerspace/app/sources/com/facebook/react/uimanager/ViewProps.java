...
public class ViewProps {
    ...
    public static boolean isLayoutOnly(ReadableMap map, String prop) {
        ...
        switch (c) {
            case 0:
                return !map.isNull(BORDER_RIGHT_COLOR) && map.getInt(BORDER_RIGHT_COLOR) == 0;
            case 1:
                return map.isNull(BORDER_RIGHT_WIDTH) || map.getDouble(BORDER_RIGHT_WIDTH) == 0.0d;
            case 2:
                return !map.isNull(BORDER_TOP_COLOR) && map.getInt(BORDER_TOP_COLOR) == 0;
            case 3:
                return map.isNull(BORDER_TOP_WIDTH) || map.getDouble(BORDER_TOP_WIDTH) == 0.0d;
            case 4:
                return !map.isNull(BORDER_BOTTOM_COLOR) && map.getInt(BORDER_BOTTOM_COLOR) == 0;
            case 5:
            ...
            case 7:
                return !map.isNull(BORDER_LEFT_COLOR) && map.getInt(BORDER_LEFT_COLOR) == 0;
            case '\b':
