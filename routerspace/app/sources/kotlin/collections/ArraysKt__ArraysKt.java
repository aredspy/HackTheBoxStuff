                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m516contentEqualslec5QzE(((ULongArray) t).m220unboximpl(), ((ULongArray) t2).m220unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m512contentEqualsKJPZfPQ(((UIntArray) t).m150unboximpl(), ((UIntArray) t2).m150unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m511contentEqualsFGO6Aew(((UShortArray) t).m316unboximpl(), ((UShortArray) t2).m316unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m514contentEqualskV0jMPg(((UByteArray) t).m80unboximpl(), ((UByteArray) t2).m80unboximpl())) {
                                                        return false;
                                                    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    if (uByteArray != null) {
                        bArr = uByteArray.m80unboximpl();
                    }
                    sb.append(UArraysKt.m528contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    if (uShortArray != null) {
                        sArr = uShortArray.m316unboximpl();
                    }
                    sb.append(UArraysKt.m532contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    if (uIntArray != null) {
                        iArr = uIntArray.m150unboximpl();
                    }
                    sb.append(UArraysKt.m531contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    if (uLongArray != null) {
                        jArr = uLongArray.m220unboximpl();
                    }
                    sb.append(UArraysKt.m534contentToStringuLth9ew(jArr));
                } else {
