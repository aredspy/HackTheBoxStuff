...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static final <T> List<T> optimizeReadOnlyList(List<? extends T> optimizeReadOnlyList) {
        ...
        if (size != 0) {
            return size != 1 ? optimizeReadOnlyList : CollectionsKt.listOf(optimizeReadOnlyList.get(0));
        }
        return CollectionsKt.emptyList();
    }
    ...
    public static /* synthetic */ int binarySearchBy$default(List binarySearchBy, Comparable comparable, int i, int i2, Function1 selector, int i3, Object obj) {
        ...
        return CollectionsKt.binarySearch(binarySearchBy, i, i2, new CollectionsKt__CollectionsKt$binarySearchBy$1(selector, comparable));
    }
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> binarySearchBy, K k, int i, int i2, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(binarySearchBy, "$this$binarySearchBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return CollectionsKt.binarySearch(binarySearchBy, i, i2, new CollectionsKt__CollectionsKt$binarySearchBy$1(selector, k));
    }
