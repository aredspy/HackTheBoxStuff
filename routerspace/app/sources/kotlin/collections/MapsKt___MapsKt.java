...
class MapsKt___MapsKt extends MapsKt__MapsKt {
    ...
    /* renamed from: maxOf */
    private static final <K, V, R extends Comparable<? super R>> R m412maxOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
    ...
    /* renamed from: minOf */
    private static final <K, V, R extends Comparable<? super R>> R m416minOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        Iterator<T> it = map.entrySet().iterator();
        if (it.hasNext()) {
            R invoke = function1.invoke((Object) it.next());
            while (it.hasNext()) {
