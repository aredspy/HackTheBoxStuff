...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 != 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m1171getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
            return;
        }
    ...
    public final int m1185getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA */
    public final int m1186getLastpVg5ArA() {
        return this.last;
    }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1187fromClosedRangeNkh28Cs(int i, int i2, int i3) {
