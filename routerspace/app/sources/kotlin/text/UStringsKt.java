...
public final class UStringsKt {
    ...
    public static final String m1252toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1254toStringolVBNx4(short s, int i) {
    ...
    public static final String m1253toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1251toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m133unboximpl = uIntOrNull.m133unboximpl();
            if (UnsignedKt.uintCompare(m133unboximpl, UInt.m90constructorimpl(255)) <= 0) {
                return UByte.m16boximpl(UByte.m22constructorimpl((byte) m133unboximpl));
            }
            return null;
        }
        return null;
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m133unboximpl = uIntOrNull.m133unboximpl();
            if (UnsignedKt.uintCompare(m133unboximpl, UInt.m90constructorimpl(65535)) <= 0) {
                return UShort.m252boximpl(UShort.m258constructorimpl((short) m133unboximpl));
            }
            return null;
        }
        return null;
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int m90constructorimpl = UInt.m90constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m319uintDivideJ1ME1BU(-1, m90constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m90constructorimpl2 = UInt.m90constructorimpl(i2 * m90constructorimpl);
            int m90constructorimpl3 = UInt.m90constructorimpl(UInt.m90constructorimpl(digitOf) + m90constructorimpl2);
            if (UnsignedKt.uintCompare(m90constructorimpl3, m90constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m90constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long m160constructorimpl = ULong.m160constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m321ulongDivideeb3DHEI(j, m160constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m160constructorimpl2 = ULong.m160constructorimpl(j2 * m160constructorimpl);
            long m160constructorimpl3 = ULong.m160constructorimpl(ULong.m160constructorimpl(UInt.m90constructorimpl(digitOf) & 4294967295L) + m160constructorimpl2);
            if (UnsignedKt.ulongCompare(m160constructorimpl3, m160constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m160constructorimpl3;
            j = -1;
        }
