...
public class StringsKt__IndentKt extends StringsKt__AppendableKt {
            ...
            if ((i2 == 0 || i2 == lastIndex) && StringsKt.isBlank(str2)) {
                ...
                while (true) {
                    if (i4 >= length2) {
                        i = -1;
                        break;
                    } else if (!CharsKt.isWhitespace(str.charAt(i4))) {
                        i = i4;
                        break;
                    } else {
                        i4++;
    ...
    public static final String prependIndent(String prependIndent, String indent) {
        ...
        return SequencesKt.joinToString$default(SequencesKt.map(StringsKt.lineSequence(prependIndent), new StringsKt__IndentKt$prependIndent$1(indent)), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, null, 62, null);
    }
