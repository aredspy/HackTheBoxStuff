...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public final double m1257getAdjustmentUwyO8pc() {
    ...
    public double mo1255elapsedNowUwyO8pc() {
        return Duration.m1285minusLRDsOJo(this.mark.mo1255elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1256plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1286plusLRDsOJo(this.adjustment, d), null);
    }
}
