...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1313copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1315copyRFiDyg4(obj, d);
    }
    ...
    public final double m1314component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4 */
    public final TimedValue<T> m1315copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1300toStringimpl(this.duration) + ")";
    }
    ...
    public final double m1316getDurationUwyO8pc() {
        return this.duration;
    }
