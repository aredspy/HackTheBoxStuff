...
public final class DurationKt {
    ...
    private static final double m1309timesmvk6XK0(int i, double d) {
        return Duration.m1289timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final double m1308timeskIfJnKk(double d, double d2) {
        return Duration.m1288timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m1262constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
