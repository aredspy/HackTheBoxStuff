...
public final class TypeReference implements KType {
    ...
    private final String asString() {
        ...
        if (cls == null) {
            ...
            str = cls.isArray() ? getArrayClassName(cls) : cls.getName();
        }
        String str2 = "";
        String joinToString$default = getArguments().isEmpty() ? str2 : CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new TypeReference$asString$args$1(this), 24, null);
        if (isMarkedNullable()) {
            str2 = "?";
        }
        return str + joinToString$default + str2;
    }
