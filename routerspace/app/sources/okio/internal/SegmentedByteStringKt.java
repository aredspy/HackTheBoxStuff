    ...
    public static final ByteString commonSubstring(SegmentedByteString commonSubstring, int i, int i2) {
        ...
        if (!(i4 >= 0)) {
            ...
            if (segment <= segment2) {
                ...
                int i6 = 0;
                while (true) {
                    iArr[i6] = Math.min(commonSubstring.getDirectory$okio()[i5] - i, i4);
                    int i7 = i6 + 1;
                    iArr[i6 + bArr2.length] = commonSubstring.getDirectory$okio()[commonSubstring.getSegments$okio().length + i5];
                    if (i5 == segment2) {
                        break;
                    }
                    i5++;
