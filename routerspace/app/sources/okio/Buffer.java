...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m1453deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size */
    public final long m1454deprecated_size() {
        return this.size;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x00c6 A[EDGE_INSN: B:46:0x00c6->B:40:0x00c6 ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
