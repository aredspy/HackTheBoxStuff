...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, ViewProps.POSITION) { // from class: androidx.transition.ChangeBounds.6
        public PointF get(View view) {
            return null;
        }
